...
const branchPerformance = [
  { name: 'Kariakoo HQ', value: 45000000 },
  { name: 'Masaki Branch', value: 32000000 },
...
const Dashboard: React.FC = () => {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-3xl font-bold text-slate-900">Head Office Overview</h2>
        <p className="text-slate-500 mt-1">Real-time insights across 4 branches.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
          <h3 className="text-lg font-bold text-slate-800 mb-6">Weekly Sales Analytics</h3>
          ...
          <div className="h-60 w-full relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div className="text-center">
                ...
                <p className="text-xs text-slate-500 uppercase">Active Branches</p>
              </div>
            </div>
          </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
        <div className="p-6 border-b border-slate-100 flex justify-between items-center">
          <h3 className="text-lg font-bold text-slate-800">Critical Stock Alerts (Expiring Soon)</h3>
